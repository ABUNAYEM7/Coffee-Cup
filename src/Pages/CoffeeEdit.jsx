...
const CoffeeEdit = () => {
  ...
  const { _id,name, chef, supplier, test, category, price, image } = coffee;
    ...
    <div className="max-w-screen-xl mx-auto my-12 p-6 flex flex-col gap-8">
      ...
      <div className="w-11/12 md:w-4/5 mx-auto bg-[#F4F3F0] p-4">
        ...
        <div className="space-y-3 text-center">
          <h3 className="text-4xl font-bold">Edit Coffee</h3>
          <p className="text-lg font-semibold w-full md:w-2/3 mx-auto">
        ...
        >
          ...
          <div className="form-control md:col-span-2">
            <button className="btn bg-[#D2B48C] text-secondary">
              Edit Coffee
            </button>
          </div>
        </form>
